//! Test operator — test a hypothesis or solution.
...
/// Tests a hypothesis or solution.
...
impl TestOperator {
    const SYSTEM_PROMPT: &str =
        "Test the hypothesis or solution. Describe the test procedure and expected outcomes.";

    /// Creates a new `TestOperator`.
    #[must_use]
    pub fn new() -> Self {
        Self {
            base: BaseOperator::new(OperatorKind::Test, "Test")
                .with_prompt("Test the hypothesis and record the outcomes."),
        }
    }
...
#[async_trait]
impl ReasoningOperator for TestOperator {
