...
//! ```rust
//! use std::sync::Arc;
//! use behest::provider::{ChatProvider, ProviderId, ChatRequest, ChatResponse, ProviderResult};
...
pub struct Extensions {
    ...
    pub tools: ExtensionPoint<dyn crate::tool::Tool>,
    /// Context adapter implementations, keyed by user-assigned name.
    pub context_adapters: ExtensionPoint<dyn crate::context::ContextAdapter>,
