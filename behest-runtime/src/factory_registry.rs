...
//! [`Box<dyn AnyComponent>`](super::component::AnyComponent).
...
///
/// ```
/// # use behest_runtime::factory_registry::{FactoryError, FactoryRegistry};
/// # use behest_runtime::component::ComponentContext;
/// # use behest_runtime::lifecycle::ShutdownToken;
