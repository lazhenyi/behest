...
mod tests {
    ...
    use super::*;
    use crate::event::{RunCompleted, RunStarted};
    use crate::event_store::{FailingRuntimeEventStore, MemoryRuntimeEventStore};
    use crate::stream::RuntimeEventId;
    use crate::stream_adapter::MemoryRuntimeStreamAdapter;
    use behest_provider::{FinishReason, ModelName, ProviderId};
