...
impl From<&behest_provider::Message> for MessageRole {
    fn from(message: &behest_provider::Message) -> Self {
        match message {
            behest_provider::Message::System { .. } => Self::System,
            behest_provider::Message::User { .. } => Self::User,
            behest_provider::Message::Assistant { .. } => Self::Assistant,
            behest_provider::Message::Tool { .. } => Self::Tool,
            _ => Self::User,
        }
    }
}
