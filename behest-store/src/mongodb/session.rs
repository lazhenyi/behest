...
impl SessionDoc {
    ...
    fn try_into_session(self) -> StoreResult<Session> {
        ...
        Ok(Session {
            id: crate::util::parse_uuid(&self.id, "session.id")?,
            title: self.title,
...
impl MessageDoc {
    ...
    fn try_into_message(self) -> StoreResult<MessageRecord> {
        ...
        Ok(MessageRecord {
            id: crate::util::parse_uuid(&self.id, "message.id")?,
            session_id: crate::util::parse_uuid(&self.session_id, "message.session_id")?,
            role,
