...
use crate::{ArtifactStore, EmbeddingStore, ExecutionStore, SessionStore, StoreResult};
...
impl MemoryStore {
    ...
    /// # Errors
    ///
    /// Returns [`StorageError::BackendError`](behest_core::error::StorageError::BackendError)
    ...
    pub async fn delete_session_cascading(&self, id: &Uuid) -> StoreResult<()> {
        ...
        if errors.is_empty() {
            ...
            Err(behest_core::error::StorageError::BackendError {
